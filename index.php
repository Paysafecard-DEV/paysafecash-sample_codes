...
<div class="container theme-showcase" role="main">
	...
	if ( count( $_POST ) > 0 ) {
		...
		if ( $_POST["submitCustomer"] == "takeover" ) {
			$customer_data = [ "first_name"    => $_POST["first_name"],
    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST">
                        ...
                        <p>
                            Date of birth:
                            <input type="text" name="date_of_birth" class="form-control" value="1990-12-31"
                                   id="date_of_birth">
                        </p>
                        <p>
                            Address1:
                            <input type="text" name="address1" class="form-control" value="Musterstrasse 2"
                                   id="address1">
                        </p>
                        <p>
                            Postcode:
                        ...
                        <p>
                            Phone Number:
                            <input type="text" name="phone_number" class="form-control" value="+43676123456789"
                                   id="phone_number">
                        </p>
                        <p>
                            E-Mail:
                        ...
                        <!-- Please insert the customer number or customer name as hashed value -->
                        <input type="hidden" name="customer_id" class="form-control"
                               value="<?php echo md5( 'test123' ) ?>">
                        <!-- ------------------------------------------------------------------- -->

                        <br>Variable Time
                        <input type="number" name="variable_time" class="form-control" value="4320" id="variable_time">
                        <br/>
                        <button type="submit" name="action" value="payment" class="btn btn-success">pay with
                            Paysafecash
                        </button>
                    </form>
                </div>
        ...
        <div class="col-sm-6">
            <p>Paysafecash is an alternative cash-based payment method that makes it possible to pay securely and easily
                with cash on the Internet.</p>
            <p>Using Paysafecash, products or services can be ordered online and then paid for with cash offline at the
                nearest Point of Sales by scanning a QR/barcode.</p>

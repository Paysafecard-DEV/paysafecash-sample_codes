    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo getURL(); ?>">Paysafecash Level 3 payment Interface</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class=""><a href="<?php echo getURL(); ?>">Payment</a></li>
                    <li class="active"><a href="<?php echo getURL(); ?>/refund.php">Refund</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
